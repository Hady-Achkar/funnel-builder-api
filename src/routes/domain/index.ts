...
router.post(
  ...
  authenticateToken,
  CreateCustomDomainController.create
);
router.post(
  "/create-subdomain",
  authenticateToken,
  CreateSubdomainController.create
);
...
router.get(
  "/dns-instructions/:id",
  authenticateToken,
  GetDNSInstructionsController.getByDomainId
);
router.get(
  "/:workspaceSlug/summary",
  authenticateToken,
  GetWorkspaceDomainsSummaryController.getWorkspaceDomainsSummary
);
router.get(
  "/:workspaceSlug",
  authenticateToken,
  GetAllDomainsController.getAllDomains
);
