...
router.post(
  "/:domainId/funnels/:funnelId/link",
  authenticateToken,
  DomainController.linkFunnelToDomain
);
router.delete(
  "/:domainId/funnels/:funnelId/link",
  authenticateToken,
  DomainController.unlinkFunnelFromDomain
);

// Public routes (no authentication required)
router.get(
  "/public/:hostname/funnels/:funnelId",
  DomainController.getPublicFunnel
);
