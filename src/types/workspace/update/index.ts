...
export const updateWorkspaceMemberRequest = z.object({
  workspaceSlug: z.string(),
  memberId: z.number(),
  role: z.enum($Enums.WorkspaceRole).optional(),
  permissions: z.array(z.enum($Enums.WorkspacePermission)).optional(),
});
...
export const rolePermissionPresets = {
  ...
  VIEWER: [WorkspacePermission.VIEW_ANALYTICS],
};
...
export type UpdateWorkspaceGeneralRequest = z.infer<
  typeof updateWorkspaceGeneralRequest
>;
...
export type AddWorkspaceMemberRequest = z.infer<
  typeof addWorkspaceMemberRequest
>;
export type RemoveWorkspaceMemberRequest = z.infer<
  typeof removeWorkspaceMemberRequest
>;
