...
describe('AzureBlobStorageService', () => {
  ...
  describe('generateFileName', () => {
    it('should generate optimized filename', () => {
      ...
      expect(result).toMatch(/^template-123-thumbnail-my-template-image-\d+\.jpg$/);
    });
  ...
  describe('configuration validation', () => {
    it('should throw error in production without connection string', () => {
      ...
      expect(() => new AzureBlobStorageService()).toThrow('Missing Azure Storage connection string in production');
    });
